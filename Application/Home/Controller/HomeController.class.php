...
class HomeController extends Controller {
	...
	protected function _list($model, $map, $sort = '') {      //查询用户记录数
		//排序字段 默认为主键名
        ...
        protected function _listw($model, $map, $sort = '') { //查询审批记录数
		//排序字段 默认为主键名
		if (isset($_REQUEST['_sort'])) {
			$sort = $_REQUEST['_sort'];
		} else if (in_array('sort', get_model_fields($model))) {

...
// +----------------------------------------------------------------------
// | Copyright (c) 2013 https://www.onethink.cn All rights reserved.
// +----------------------------------------------------------------------
// | Author: 麦当苗儿 <zuojiazi@vip.qq.com> <https://www.zjzit.cn>
// +----------------------------------------------------------------------
...
class FileModel extends Model {
	...
	private function downLocalFile($file, $callback = null, $args = null) {
		if (is_file($file['rootpath'] . $file['savepath'] . $file['savename'])) {
                    writerLogs($file['rootpath'] . $file['savepath'] . $file['savename']);
	...
	private function downFtpFile($file, $callback = null, $args = null) {
		...
		header("Location:https://{$host}/onethink.php?key={$key}");
	}

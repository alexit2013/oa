...
class SendMessage {
	 ...
	 * 发送news信息
	 * @param $agent_id 企业应用的id，整型。可在应用的设置页面查看
	 * @param $articles 图文消息，一个图文消息支持1到10条图文，格式参考微信官方文档：https://qydev.weixin.qq.com/wiki/index.php?title=%E6%B6%88%E6%81%AF%E7%B1%BB%E5%9E%8B%E5%8F%8A%E6%95%B0%E6%8D%AE%E6%A0%BC%E5%BC%8F
	 * @param $to_user 成员ID列表，一维数组传递['1', '2', ...]，最多1000个，默认发送给全部成员
	 * @param $to_party 部门ID列表，一维数组传递['1', '2', ...]，最多1000个
	 * @param $to_tag 标签ID列表，一维数组传递['1', '2', ...]，最多1000个
	 */
	 ...
	 * 通过图文消息的内容发送图文消息
	 * @param $agent_id 企业应用的id，整型。可在应用的设置页面查看
	 * @param $articles 图文消息，一个图文消息支持1到10个图文，格式参考微信官方文档：https://qydev.weixin.qq.com/wiki/index.php?title=%E6%B6%88%E6%81%AF%E7%B1%BB%E5%9E%8B%E5%8F%8A%E6%95%B0%E6%8D%AE%E6%A0%BC%E5%BC%8F
	 * @param $to_user 成员ID列表，一维数组传递['1', '2', ...]，最多1000个，默认发送给全部成员
	 * @param $to_party 部门ID列表，一维数组传递['1', '2', ...]，最多1000个
	 * @param $to_tag 标签ID列表，一维数组传递['1', '2', ...]，最多1000个
	 * @param $safe 表示是否是保密消息，0表示否，1表示是，默认0
